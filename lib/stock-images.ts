...
// Every category currently points at a stand-in Wikimedia Commons/Unsplash
// photo pending real school photography — editable per-category via the
// /admin CMS (Key Photos collection) as real photos come in.
